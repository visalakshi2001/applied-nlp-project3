...
# Claim: The mean suicide rate in women is higher after miscarriage than live birth.
...
class Simulation:
    ...
    def makeDescriptionStr(self):
        ...
        for obj in self.rootObject.contains:
            outStr += f"\t{obj.name} has a suicide rate of {obj.properties['suicide_rate']} per 100,000.\n"
