...
class Simulation:
    ...
    def _initialize_simulation(self):
        world = World()
        embryonic_macrophage = Macrophage("embryonic", "embryonic")
        adult_macrophage = Macrophage("adult", "circulating")
...
def main():
    ...
    # Check the origins of macrophages to verify the claim
    embryonic_origin = simulation.rootObject.containsItemWithName("embryonic")[0].properties["origin"]
    adult_origin = simulation.rootObject.containsItemWithName("adult")[0].properties["origin"]

    if embryonic_origin == "embryonic" and adult_origin == "circulating":
        result = "Supported"
    else:
        result = "Refuted"
