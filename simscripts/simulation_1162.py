...
# Claim: The DdrB protein from Deinococcus radiodurans functions as a pentamer.
...
# DdrB protein simulation
class DdrBProtein(GameObject):
    def __init__(self, name):
        super().__init__(name)
        self.properties = {
            "structure": "pentameric ring",
            "binding": "single-stranded DNA"
        }

    def makeDescriptionStr(self):
        description = f"{self.name} is a {self.properties['structure']} capable of binding {self.properties['binding']}."
        return description
...
class Simulation:
    ...
    def _initialize_simulation(self):
        world = World()
        ddrB = DdrBProtein("DdrB protein")
        world.addObject(ddrB)        
        return world
...
def main():
    ...
    if "pentameric ring" in simulation.observationStr:
        result = "Supported"
    else:
        result = "Refuted"
